...
<div class="box">
      <p style="text-align: left;">First name: <span><?= $fetch_account['fname']; ?></span></p>
      <p style="text-align: left;"> Last name: <span><?= $fetch_account['lname']; ?></span> </p>
      <p style="text-align: left;"> Email: <span><?= $fetch_account['email']; ?></span> </p>
      <div class="flex-btn">
         <a href="user_account.php?delete=<?= $fetch_account['id']; ?>" class="delete-btn" onclick="return confirm('Delete this account?');">Delete</a>
